#ifndef CONSTANTS_BLE11
#define CONSTANTS_BLE11
...
public:
    ...
    enum t_mac_LLID {//spec v4.1 p. 1248
        LLID_Data_frag_1=1
        ,LLID_Data_start_2
    ...
    typedef struct tAdvertisePars{//spec v4.1 p. 1246
        ...
        //set default values
        tAdvertisePars(): Advertising_Interval_Min(0x800),Advertising_Interval_Max(0x800),Adv_Type(ADV_IND_0),Own_Address_Type(OWN_ADDR_PUBLIC_0),Direct_Address_Type(DIRECT_ADDR_PUBLIC_0),Direct_Address(),Advertising_Channel_Map(),Advertising_Filter_Policy(ANY_0){}

/*        tAdvertisePars(const tAdvertisePars& o): Advertising_Interval_Min(o.Advertising_Interval_Min),Advertising_Interval_Max(o.Advertising_Interval_Max),Adv_Type(o.Adv_Type),Own_Address_Type(o.Own_Address_Type),Direct_Address_Type(o.Direct_Address_Type),Direct_Address(o.Direct_Address),Advertising_Channel_Map(o.Advertising_Channel_Map),Advertising_Filter_Policy(o.Advertising_Filter_Policy){}
        tAdvertisePars(const int AdvertisingIntervalMin): Advertising_Interval_Min(AdvertisingIntervalMin),Advertising_Interval_Max(o.Advertising_Interval_Max),Adv_Type(o.Adv_Type),Own_Address_Type(o.Own_Address_Type),Direct_Address_Type(o.Direct_Address_Type),Direct_Address(o.Direct_Address),Advertising_Channel_Map(o.Advertising_Channel_Map),Advertising_Filter_Policy(o.Advertising_Filter_Policy){}
*/
    }tAdvertisePars;
